...
import { LoginWithGoogle } from "@/auth/_components/login-with-google";
import { login } from "@/auth/login/_actions/login";
import { LoginSchema, TLogin } from "@/auth/login/_zodschema/login";
    ...
    <div className=" w-[300px] p-2 flex justify-center items-center ">
      <div className="flex flex-col items-center gap-2 mb-4 w-full">
        <Image
          ...
          width={56}
          height={56}
          className="mx-auto rounded-full border-0 border-gray-100 md:block m-4"
        />
        ...
        >
          ...
          <LoginWithGoogle disabled={isPending} callbackUrl={callbackUrl} />
          <div>
            <Link
              href="/buat-akun"
